...
class PatchEmbedding(nn.Module):
    def __init__(self, d_model, patch_len, stride, dropout):
        ...
        self.value_embedding = TokenEmbedding(patch_len*3, d_model)
    ...
    def forward(self, x):
        ...
        x = x.permute(0, 2, 1, 3)  # [batch_size, num_patches, n_vars, patch_len]
        # Merge the last two dimensions
        x = x.reshape(x.shape[0], x.shape[1], -1)  # [batch_size, num_patches, n_vars*patch_len]
        # Input encoding
        x = self.value_embedding(x)
